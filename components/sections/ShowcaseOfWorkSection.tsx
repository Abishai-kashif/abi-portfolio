    ...
    <section className="py-16 px-4 bg-white/5 backdrop-blur-sm">
      <div className="container-layout">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <Card key={i} className="bg-white/10 border-light-purple/30 overflow-hidden">
              ...
              <CardContent>
                <p className="text-white/80 mb-4">Brief description of the project and technologies used.</p>
                <Button
                  variant="outline"
                  size="sm"
