...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      "rounded-[24px] bg-dark-purple/35 backdrop-blur p-2 no-underline shadow-sm transition-colors text-white max-w-[350px] sm:max-w-full mx-auto",
...
>(({ className, alt, src, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "relative mb-6 h-[180px] rounded-[20px] w-full",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("mt-3 px-1 text-lg font-semibold leading-tight", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center pb-1 pt-0", className)}
    {...props}
  />
))
